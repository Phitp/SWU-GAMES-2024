...
if (!$username_in1) {
  ...
  echo "<meta http-equiv='refresh' content='2;url=../admin/add_admin.php'>";
}
if (!$password_in1) {
...
if ($status_in1 == "Soswu" && (!$faculty_in1 || !$year_in1 || !$file_img)) {
  echo '<div align="center"><font color="#FF3300">';
  echo "<br>กรุณากรอกข้อมูลให้ครบถ้วน";
  echo "<meta http-equiv='refresh' content='2;url=../admin/add_admin.php'>";
}
if ($status_in1 == "Smo" && (!$faculty_in1 || !$year_in1 || !$file_img)) {
  echo '<div align="center"><font color="#FF3300">';
  echo "<br>กรุณากรอกข้อมูลให้ครบถ้วน";
  echo "<meta http-equiv='refresh' content='2;url=../admin/add_admin.php'>";
}
